...
public class ProductUpdateCommandHandler {
    ...
    public ProductUpdateCommandHandler(ProductDomainService productDomainService, ProductDataMapper productDataMapper, ProductHelper productHelper, ProductUpdatedMessagePublisher productUpdatedMessagePublisher) {
