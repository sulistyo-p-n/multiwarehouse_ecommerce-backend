package com.multiwarehouse.app.kafka.consumer.config;

import com.multiwarehouse.app.kafka.config.data.KafkaConfigData;
import com.multiwarehouse.app.kafka.config.data.KafkaConsumerConfigData;
