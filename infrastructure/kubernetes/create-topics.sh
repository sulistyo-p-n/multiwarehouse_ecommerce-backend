...
kafka-topics --zookeeper $1:2181 --topic inventory-product-stock-change --delete --if-exists
...
kafka-topics --zookeeper $1:2181 --topic inventory-product-stock-change --create --partitions 3 --replication-factor 3 --if-not-exists
